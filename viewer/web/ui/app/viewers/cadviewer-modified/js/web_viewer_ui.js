var __extends = this && this.__extends || function() {
    ...
    return function(h, m) {
        ...
        f(h, m);
        h.prototype = null === m ? Object.create(m) : (e.prototype = m.prototype,
        new e)
    }
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(e) {
                    ...
                    case 1:
                        ...
                        g = a.getPosition(),
                        k = new h(this._viewer,d,g,this._viewer.model.getNodeName(d) + " Connector"),
                        l = this._viewer.markupManager.registerMarkup(k),
                        this._annotationRegistry.addAnnotation(l, k),
                        this._startDraggingAnnotation(k, b),
                        c.setHandled(!0));
                        return [2]
                    }
                })
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(l) {
                    ...
                    case 2:
                        g = l.sent(),
                        k = g.getNodeId(),
                        k !== this._previousNodeId && (null != this._previousNodeId && this._viewer.model.setNodesHighlighted([this._previousNodeId], !1),
                        null != k && this._viewer.model.setNodesHighlighted([k], !0)),
                        this._previousNodeId = k,
                        l.label = 3;
                    case 3:
                        return [2]
                    }
            ...
            var c = function() {
                    ...
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(g) {
                            ...
                            case 0:
                                ...
                                l = (c = this._contextItemMap.setColor).setText,
                                [4, this._isColorSet(b)];
                            case 1:
                                return l.apply(c, [(g.sent() ? "Uns" : "S") + "et Color"]),
                                (e = this._viewer.operatorManager.getOperator(f.OperatorId.Handle)) && e.isEnabled && d ? (h = 0 < b.length && e.isEnabled(),
                                this._contextItemMap.handles.setEnabled(h)) : this._contextItemMap.handles.setEnabled(!1),
                ...
                a.prototype.showElements = function(b) {
                    ...
                    var d = this._viewer.view.getCanvasSize()
                      ...
                      , c = a.outerWidth()
                      , l = a.outerHeight();
                    void 0 !== l && void 0 !== c && (l > d.y && a.addClass("small"),
                    a = b.y,
                    b = b.x,
                    a + l > d.y && (a = d.y - l - 1),
                    b + c > d.x && (b = d.x - c - 1),
                ...
                a.prototype._createDefaultMenuItems = function() {
                    ...
                    this.appendItem("transparent", "Transparent", function() {
                        return __awaiter(b, void 0, void 0, function() {
                            ...
                            return __generator(this, function(e) {
                                if (this._isMenuItemExecutable())
                                    if (b = this.getContextItemIds(!0, !0),
                                    void 0 === this._transparencyIdHash.get(b[0])) {
                                        a = 0;
                                        for (g = b; a < g.length; a++)
                                            c = g[a],
                                            this._transparencyIdHash.set(c, 1);
                                        d.setNodesOpacity(b, .5)
                                    } else {
                                        k = 0;
                                        for (l = b; k < l.length; k++)
                                            c = l[k],
                                            this._transparencyIdHash.delete(c);
                                        d.resetNodesOpacity(b)
                                    }
                                return [2]
                            })
                        })
                    ...
                    this.appendItem("setColor", "Set Color", function() {
                        return __awaiter(b, void 0, void 0, function() {
                            ...
                            return __generator(this, function(a) {
                                switch (a.label) {
                                case 0:
                                    return d = this.getContextItemIds(!0, !0, !1),
                                    0 < d.length ? [4, this._isColorSet(d)] : [3, 2];
                                case 1:
                                    a.sent() ? this._viewer.model.unsetNodesFaceColor(d) : (b = this._colorPicker.getColor().copy(),
                                    this._viewer.model.setNodesFaceColor(d, b)),
                                    a.label = 2;
                                case 2:
                                    return [2]
                                }
                    ...
                    this.appendItem("reset", "Reset Model", function() {
                        return __awaiter(b, void 0, void 0, function() {
                            ...
                            return __generator(this, function(g) {
                                switch (g.label) {
                                case 0:
                                    return b = a.getOperator(f.OperatorId.Handle),
                                    [4, b.removeHandles()];
                                case 1:
                                    return g.sent(),
                                    [4, d.reset()];
                ...
                a.prototype.getContextItemIds = function(b, d, a) {
                    ...
                    null !== c))
                        for (b = 0; b < c.length; b++)
                            if (m = this._viewer.model.getNodesFromLayer(c[b]),
                            null !== m)
                                for (q = 0; q < m.length; q++) {
                                    var n = m[q]
                                      , r = f.Selection.SelectionItem.create(n);
                                    g.contains(r) || h.push(n)
                                }
                    null !== this._activeType && (m = this._viewer.model.getNodesByGenericType(this._activeType),
                    null !== m && m.forEach(function(d) {
                        var b = f.Selection.SelectionItem.create(d);
                        g.contains(b) || h.push(d)
                    }));
                    null !== this._activeItemId && (r = f.Selection.SelectionItem.create(this._activeItemId),
                    c = null !== g.containsParent(r),
                    b = -1 !== h.indexOf(this._activeItemId),
                    !d || !a && (a || this._activeItemId === e || 0 !== h.length && (b || c)) || h.push(this._activeItemId));
                    return h
                };
    ...
    (function(h) {
        ...
        var e = function() {
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(k) {
                        ...
                        case 0:
                            ...
                            a[2] = c.getPlane(2),
                            a[3] = c.getPlane(3),
                            b[0] = c.getReferenceGeometry(0),
                            b[1] = c.getReferenceGeometry(1),
                            b[2] = c.getReferenceGeometry(2),
                            b[3] = c.getReferenceGeometry(3)) : (g = !0,
                            a[0] = c.getPlane(0),
                            a[1] = l.getPlane(0),
                            a[2] = e.getPlane(0),
                            a[3] = f.getPlane(0),
                            b[0] = c.getReferenceGeometry(0),
                            b[1] = l.getReferenceGeometry(0),
                            b[2] = e.getReferenceGeometry(0),
                            b[3] = f.getReferenceGeometry(0));
                            if (null !== b[0] || null !== b[1] || null !== b[2] || null !== b[3])
                                d = !0;
                            ...
                            for (h = 0; h < a.length; ++h)
                                m = a[h],
                                null !== m && (n = this._getPlaneSectionIndex(m),
                                r = this._ensurePlaneInfo(n),
                                0 === r.status && (r.status = this._getCuttingStatus(n, m),
                                r.plane = m,
                                r.referenceGeometry = b[h]));
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(c) {
                        ...
                        case 1:
                            ...
                            d = this._modelBounding.max.equalsWithTolerance(a.max, .01);
                            if (b && d)
                                return [3, 4];
            ...
            c.prototype._initSection = function() {
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(d) {
                        ...
                        case 1:
                            return a = d.sent(),
                            this._modelBounding = a.copy(),
                            b = this._viewer.cuttingManager,
                            this._cuttingSections[0] = b.getCuttingSection(0),
                            this._cuttingSections[1] = b.getCuttingSection(1),
                            this._cuttingSections[2] = b.getCuttingSection(2),
                            this._cuttingSections[3] = b.getCuttingSection(3),
                            [4, this._triggerPendingFuncs()];
                        case 2:
                            return d.sent(),
                            this._initSectionCalled = !0,
                            [2]
                        }
                    })
                })
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(g) {
                        ...
                        case 7:
                            return [3, 12];
                        case 8:
                            return this._setStatus(a, 2),
                            [4, this.setCuttingPlaneInverted(a)];
                        case 9:
                            return g.sent(),
                            [3, 12];
                        case 10:
                            return this._setStatus(a, 0),
            ...
            c.prototype.getCount = function() {
                for (var a = 0, b = 0, d = this._cuttingSections; b < d.length; b++)
                    a += d[b].getCount();
                return a
            };
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(k) {
                        ...
                        case 3:
                            ...
                            k.label = 4;
                        case 4:
                            return l = this.getCount(),
                            e = this._isActive(b),
                            0 < l && !e ? [4, this._activatePlanes()] : [3, 6];
                        case 5:
                            return k.sent(),
                            [3, 8];
                        case 6:
            ...
            c.prototype._clearCuttingSection = function(a) {
                return __awaiter(this, void 0, void 0, function() {
                    var b;
                    return __generator(this, function(d) {
                        switch (d.label) {
                        case 0:
                            return b = this._cuttingSections[a],
                            void 0 === b ? [3, 2] : [4, b.clear()];
                        case 1:
                            d.sent(),
                            d.label = 2;
                        case 2:
            ...
            c.prototype._activateSection = function(a) {
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(d) {
                        ...
                        case 0:
                            return b = this._cuttingSections[a],
                            void 0 !== b && 0 < b.getCount() ? [4, b.activate()] : [3, 2];
                        case 1:
                            d.sent(),
                            d.label = 2;
                        case 2:
            ...
            c.prototype._getPlaneIndex = function(a) {
                if (this._useIndividualCuttingSections) {
                    a = this._getCuttingSectionIndex(a);
                    ...
                    for (var d = b.getCount(), g = 0; g < d; g++) {
                        ...
                        if (c && (c.normal.x && 0 === a || c.normal.y && 1 === a || c.normal.z && 2 === a || 3 === a && l && c.normal.equals(l)))
                            return g
                    }
                }
                return -1
            ...
            c.prototype._generateReferenceGeometry = function(a) {
                var b = this._viewer.cuttingManager
                  , d = [];
                if (3 === a)
                    this._faceSelection && (a = this._faceSelection.getFaceEntity().getNormal(),
                    d = this._faceSelection.getPosition(),
                    d = b.createReferenceGeometryFromFaceNormal(a, d, this._modelBounding));
                else {
                    var g = void 0;
                    switch (a) {
                    case 0:
...
(function(f) {
    ...
    var m = function() {
        ...
        e.prototype.showAll = function() {
            ...
            null !== this._camera && (this._viewer.view.setCamera(this._camera, f.DefaultTransitionDuration),
            this._camera = null);
            this._isolateStatus = !1;
      ...
      , m = function() {
        ...
        e.prototype.update = function() {
            ...
            for (var c = Date.now(), a = c - this._previousTime, b = {}, d = !1, g = 0, k = Object.keys(this._pulseInfoMap); g < k.length; g++) {
                ...
                b[l.id] = e;
                l.progress >= l.duration && (l.direction = 0 === l.direction ? 1 : 0,
                l.progress = 0)
            }
            ...
            c.prototype.doContext = function(a) {
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(c) {
                        switch (c.label) {
                        case 0:
                            return b = new f.PickConfig(f.SelectionMask.All),
                            [4, this._viewer.view.pickFromPoint(a, b)];
                        case 1:
                            return d = c.sent(),
                            d.isNodeSelection() && (g = this._viewer.model.getNodeType(d.getNodeId())),
                            void 0 !== g && g !== f.NodeType.Pmi && g !== f.NodeType.PmiBody && 1 !== d.overlayIndex() ? [3, 3] : [4, this.setActiveItemId(null)];
                        case 2:
                            return c.sent(),
                            [3, 5];
                        case 3:
                ...
                return __awaiter(this, void 0, void 0, function() {
                    return __generator(this, function(b) {
                        ...
                        case 1:
                            ...
                            [3, 3];
                        case 2:
                            e.prototype._onContextLayerClick.call(this, a),
                            b.label = 3;
                        case 3:
                            return [2]
                        }
    ...
    (function(h) {
        var m = function() {
            function e(c, a) {
                ...
                this._opacity = .5;
                this._spinnerImageUrl = "ui/img/loading-icon.gif";
        ...
        var m = function() {
            ...
            e.prototype.reposition = function() {
                ...
                if (void 0 !== c && void 0 !== a) {
					var canvasCenterX = a.width() / 2;
					var toolbarX = canvasCenterX - (c.width() / 2);
                }
            };
            ...
            e.prototype._alignMenuToTool = function(c, a) {
                ...
                var b = c.width()
                  , d = c.height();
				var leftpos = a - (b / 2) + 20;
                void 0 !== b && void 0 !== d && c.css({
                    display: "block",
                    left: leftpos,
					bottom: -(this._submenuHeightOffset + d) + "px"
                })
            };
            ...
            e.prototype._activateSubmenuItem = function(c) {
                ...
                if ("string" !== typeof b)
                    throw new f.CommunicatorError("Invalid submenuItem.");
                a = $("#" + a.data("button"));
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(u) {
                        ...
                        case 1:
                            ...
                            p = (k - d) / 2,
                            n = $("#snapshot-dialog"),
							o = $( "#waterMarkContainer").clone(),
                            $("#snapshot-dialog-image").attr("src", m.src).attr("width", e).attr("height", b + 40),
                            n.css({
                                top: "45px",
                                left: p + "px"
                            }),
							div = document.getElementById('snapshot-dialog'),
							o.css({
								'height': b+"px",
								'position':'fixed',
								'z-index':'1000',
								'clip':'rect(0px,'+e+'px,'+b+'px,0px)'
							}),
							$("#snapshot-dialog").prepend(o),
							handleError('Please close the print window to proceed.'),
							sendActivity(),
							$('#pageWrapper').block({message: '',overlayCSS: { backgroundColor: '#fff' }}),
							win = window.open('','Print-Window','width=1000,height=1000'),
							win.document.open(),
							win.document.write('<html><head><meta name="format-detection" content="date=no"><meta name="format-detection" content="address=no"><meta name="format-detection" content="telephone=no"></head><body onload="window.print()">'+div.innerHTML+'</body></html>'),
							win.document.close(),
							o.remove();
							setTimeout(function(){
								win.close();
            ...
            e.prototype._initActions = function() {
                ...
                this._actionsNullary.set("toolbar-home", function() {
                    ...
                    if (!c._viewer.sheetManager.isDrawingSheetActive()) {
                        ...
                        var d = b.getOperator(f.OperatorId.Handle);
                ...
                this._actionsNullary.set("toolbar-measure-distance", function() {
                    b.set(f.OperatorId.MeasureFaceFaceDistance, 1)
                });
                ...
                this._actionsNullary.set("toolbar-back", function() {
                    return __awaiter(c, void 0, void 0, function() {
                        return __generator(this, function(d) {
                            switch (d.label) {
                            case 0:
                                return [4, a.setViewOrientation(f.ViewOrientation.Back, this._viewOrientationDuration)];
                            case 1:
                                return d.sent(),
                                [2]
                            }
            ...
            e.prototype._explosionButtonClick = function(c) {
            ...
            e.prototype._cuttingPlaneButtonClick = function(c) {
                var a = this;
            ...
            e.prototype._updateCuttingPlaneIcons = function() {
                ...
                c ? $(this._cuttingPlaneVisibilitySelector).removeClass(this._selectedClass) : $(this._cuttingPlaneVisibilitySelector).addClass(this._selectedClass);
                ...
                0 < b ? ($(this._cuttingPlaneVisibilitySelector).removeClass(this._disabledClass),
    ...
    (function(h) {
        var m = function() {
            ...
            e.prototype._updateColor = function() {
                ...
                $("#" + this._colorPickerActiveColorSwatchId).css("background", h.cssHexStringFromColor(this._color))
            };
            e.prototype.show = function() {
        ...
        (function(m) {
            ...
            var c = function() {
                ...
                a.prototype._setTreeVisibility = function(b, d) {
                    ...
                    b instanceof h.BCFTree ? this._setPropertyWindowVisibility(!1) : this._setPropertyWindowVisibility(!0)) : (c.hide(),
                ...
                a.prototype._addTree = function(b, d) {
                    ...
                    var c;
                    d === e.Model ? c = new h.ModelTree(this._viewer,b,a) : d === e.CadView ? c = new h.CadViewTree(this._viewer,b,a) : d === e.Sheets ? c = new h.SheetsTree(this._viewer,b,a) : d === e.Configurations ? c = new h.ConfigurationsTree(this._viewer,b,a) : d === e.Layers ? c = new h.LayersTree(this._viewer,b,a) : d === e.Filters ? c = new h.FiltersTree(this._viewer,b,a) : d === e.Types ? c = new h.TypesTree(this._viewer,b,a) : d === e.BCF ? c = new h.BCFTree(this._viewer,b,a) : f.Util.TypeAssertNever(d);
                ...
                a.prototype._createIScrollWrapper = function(b) {
                    var d = this._createDiv(b + "ScrollContainer", []);
                    d.classList.add("tree-scroll-container");
                    d.appendChild(this._createDiv(b, []));
                ...
                a.prototype.onResize = function(b) {
                    ...
                    void 0 !== d && void 0 !== a && (this._treePropertyContainer.style.height = b - d - 2 * this._browserWindowMargin + "px",
                    d = b - d - a - 2 * this._browserWindowMargin,
                ...
                a.prototype._onSlide = function() {
                    var b = $(this._header).outerHeight()
                      ...
                      , a = $(this._propertyWindow).outerHeight();
                    void 0 !== b && void 0 !== d && void 0 !== a && (this._browserWindow.style.height = d + b + a + "px")
                };
...
var __assign = this && this.__assign || function() {
    __assign = Object.assign || function(f) {
        for (var h, m = 1, e = arguments.length; m < e; m++) {
            h = arguments[m];
            for (var c in h)
                Object.prototype.hasOwnProperty.call(h, c) && (f[c] = h[c])
        }
        return f
    };
            ...
            var c = function() {
                function a(b, d) {
                    ...
                    if (void 0 === this._params.containerId)
                        throw new f.ParseError("Must supply 'containerId'.");
                    ...
                    this._cuttingPlaneController = new h.CuttingPlaneController(this._viewer);
                    this._isolateZoomHelper = new f.IsolateZoomHelper(this._viewer);
                    c && (this._toolbar = new h.Toolbar(this._viewer,this._cuttingPlaneController,d),
                    this._toolbar.init());
                    ...
                    d.appendChild(b),
                    this._modelBrowser = new m.ModelBrowser(b.id,d.id,this._viewer,this._isolateZoomHelper,this._colorPicker));
                    ...
                    this._viewer.setCallbacks({
                        ...
                        XHRonloadend: function(d, b, a) {
                            404 === b && (d = new h.UiDialog("content"),
                            d.setTitle("404 Error"),
                            d.setText("Unable to load " + a),
                            d.show())
                        },
                ...
                a.prototype._configureUi = function(b) {
                    if (this._uiModelType !== b) {
                        ...
                        b === e.Drawing ? (d.disable(),
                        a.disable(),
                        this._viewer.view.setDrawMode(f.DrawMode.WireframeOnShaded)) : (d.enable(),
                        b === e.Bim ? this._viewer.view.setBackfacesVisible(!0) : a.enable());
                        this._configureToolbar(b);
                        this._configureModelBrowser(b)
                    }
                };
                a.prototype._configureToolbar = function(b) {
                    null !== this._toolbar && (b === e.Drawing ? ($("#cuttingplane-button").hide(),
            ...
            var e = function(c) {
                ...
                a.prototype._initEvents = function() {
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(a) {
                            ...
                            case 3:
                                return a.sent(),
                                this._viewer.getStreamingMode() === f.StreamingMode.OnDemand && (b = function() {
                ...
                a.prototype._registerContextMenuCallback = function(b) {
                    return __awaiter(this, void 0, void 0, function() {
                        var d, a = this;
                        return __generator(this, function(c) {
                            d = this._treeMap.get(b);
                            void 0 !== d && d instanceof h.ViewTree && d.registerCallback("context", function(d, b) {
                                return __awaiter(a, void 0, void 0, function() {
                                    return __generator(this, function(a) {
                                        switch (a.label) {
                                        case 0:
                                            return [4, this._onTreeContext(d, b)];
                                        case 1:
                                            return a.sent(),
                                            [2]
                                        }
                ...
                a.prototype._onTreeContext = function(b, d) {
                    return __awaiter(this, void 0, void 0, function() {
                        var a, c, l;
                        return __generator(this, function(g) {
                            switch (g.label) {
                            case 0:
                                a = b.split(h.ModelTree.separator);
                                c = a[0];
                                switch (c) {
                                case "layer":
                                    return [3, 1];
                            ...
                            case 2:
                                ...
                                [3, 8];
                            case 3:
                                return [4, this.setActiveType(a[1])];
                            case 4:
                                return g.sent(),
                                [3, 8];
                            case 5:
                                return l = parseInt(a[1], 10),
                                [4, this.setActiveItemId(l)];
                            case 6:
                                return g.sent(),
                                [3, 8];
                            case 7:
    ...
    (function(f) {
        (function(f) {
            ...
            var c = function() {
                ...
                a.prototype._createRow = function(b, d, a) {
                    void 0 === a && (a = "");
                    var c = document.createElement("tr");
                    c.id = "propertyTableRow_" + b + "_" + d;
                    0 < a.length && c.classList.add(a);
                    a = document.createElement("td");
                    a.id = "propertyDiv_" + b;
                    a.innerHTML = b;
                ...
                a.prototype._onPartSelection = function(a) {
                    return __awaiter(this, void 0, void 0, function() {
                        var d, b, c, l, f, h, m, p, n, r, v, w, t, x, z, y, C;
                        return __generator(this, function(g) {
                            switch (g.label) {
                            case 0:
                            ...
                            case 1:
                                h = g.sent();
                                m = [];
                                if (null !== h && (m = Object.keys(h),
                                0 < m.length))
                                    for (l = document.createElement("table"),
                                    l.id = "propertyTable",
                                    l.appendChild(this._createRow("Property", "Value", "headerRow")),
                                    l.appendChild(this._createRow("Name", null !== c ? c : "unnamed")),
                                    p = 0,
                                    n = m; p < n.length; p++)
                                        r = n[p],
                                        v = e(r),
                                        w = e(h[r]),
                                        l.appendChild(this._createRow(v, w));
                                t = d.getNodeUserDataIndices(b);
                                if (0 < t.length)
                                    for (f = document.createElement("table"),
                                    f.id = "propertyTable",
                                    f.appendChild(this._createRow("User Data Index", "User Data Size", "headerRow")),
                                    x = 0,
                                    z = t; x < z.length; x++)
                                        y = z[x],
                                        C = d.getNodeUserData(b, y),
                                        v = "number" === typeof y ? "0x" + y.toString(16).toUpperCase() : "0x" + y,
                                        w = "" + C.length,
                                        f.appendChild(this._createRow(v, w));
                                if (null === l && null === f)
                                    return [2];
                                this._update("");
            ...
            var c = function() {
                ...
                a.prototype._scaleForMobile = function() {
                    var b = $("#" + this._viewerSettingsSelector)
                      ...
                      , a = this._viewer.view.getCanvasSize()
                      , c = b.width();
                    void 0 !== c && 1.8 * c > a.x && d.css("width", a.x / 1.8);
                    c = b.height();
                    if (void 0 !== c && 1.8 * c > a.y) {
                        b.show();
                        c = $("#" + this._viewerSettingsSelector + " .hoops-ui-window-header").get(0).offsetHeight;
                        var l = $("#" + this._viewerSettingsSelector + " .hoops-ui-window-footer").get(0).offsetHeight;
                        b.hide();
                        d.css("height", a.y / 1.8 - 1.4 * (c + l))
                    }
                };
                a.prototype._initElements = function() {
                    var a = this;
                        ...
                        firstModelLoaded: function() {
                            return __awaiter(a, void 0, void 0, function() {
                                ...
                                return __generator(this, function(c) {
                                    switch (c.label) {
                                    case 0:
                                        return d = this._viewer.operatorManager,
                                        a = d.getOperator(f.OperatorId.KeyboardWalk),
                                        b = a.getWalkSpeed(),
                                        0 >= b ? [4, a.resetDefaultWalkSpeeds()] : [3, 2];
                                    case 1:
                                        c.sent(),
                ...
                a.prototype._updateSettings = function() {
                    ...
                    k = k.getHighlightFaceElementSelection() && k.getHighlightLineElementSelection();
                    var z = l.getCappingFaceColor();
                    l = l.getCappingLineColor();
                    var y = d.getAmbientOcclusionEnabled()
                      , C = d.getAmbientOcclusionRadius()
                    ...
                    $("#settings-enable-face-line-selection").prop("checked", k);
                    ...
                    A.push(d.getPointSize().then(function(d) {
                        ...
                        a._splatRenderingEnabled && (a._splatRenderingSize = b,
                        a._splatRenderingPointSizeUnit = d);
                ...
                a.prototype._applySettings = function() {
                    ...
                    this._viewer.operatorManager.getOperator(f.OperatorId.Select).setForceEffectiveSceneVisibilityMask(k);
                    ...
                    $("#settings-anti-aliasing").prop("checked") ? d.setAntiAliasingMode(f.AntiAliasingMode.SMAA) : d.setAntiAliasingMode(f.AntiAliasingMode.None);
                    ...
                    this._splatRenderingSize = parseFloat(h.getValueAsString("#settings-splat-rendering-size")),
                    this._splatRenderingPointSizeUnit = parseInt(h.getValueAsString("#settings-splat-rendering-point-size-unit"), 10),
                    d.setPointSize(this._splatRenderingSize, this._splatRenderingPointSizeUnit)) : (this._splatRenderingEnabled = !1,
                    d.setPointSize(1, f.PointSizeUnit.ScreenPixels));
                ...
                a.prototype._applyWalkKeyText = function(a, d) {
                    d < f.KeyCode.a || d > f.KeyCode.z || (a = this._walkKeyIdsMap.get(a),
                    d = f.KeyCode[d].toUpperCase(),
                    $("#" + a).html(d))
                };
                a.prototype._applyWalkSettings = function() {
                    return __awaiter(this, void 0, void 0, function() {
                        var a, d, c, k, l, e, m, q, p, n, r, v, w = this;
                        return __generator(this, function(b) {
                            switch (b.label) {
                            case 0:
                                return a = this._viewer.operatorManager,
                                d = a.getOperator(f.OperatorId.KeyboardWalk),
                                c = a.getOperator(f.OperatorId.WalkMode),
                                k = parseInt(h.getValueAsString("#settings-walk-mode"), 10),
                                [4, c.setWalkMode(k)];
                            case 1:
                                return b.sent(),
                                l = parseInt(h.getValueAsString("#settings-walk-rotation"), 10),
                                e = parseFloat(h.getValueAsString("#settings-walk-speed")) * this._walkSpeedUnits,
                                m = parseFloat(h.getValueAsString("#settings-walk-elevation")) * this._walkSpeedUnits,
                                q = parseInt(h.getValueAsString("#settings-walk-view-angle"), 10),
                                p = $("#settings-mouse-look-enabled").prop("checked"),
                                n = parseInt(h.getValueAsString("#settings-mouse-look-speed"), 10),
                            ...
                            case 2:
                                ...
                                [3, 4];
                            case 3:
                                c.setRotationSpeed(l),
                                c.setWalkSpeed(e),
                                c.setElevationSpeed(m),
                                c.setViewAngle(q),
                                k === f.WalkMode.Keyboard && (d.setMouseLookEnabled(p),
                                d.setMouseLookSpeed(n)),
                                b.label = 4;
                            case 4:
                ...
                a.prototype._updateWalkSettingsHelper = function() {
                    ...
                    this._updateEnabledStyle("settings-bim-mode-enabled", [], [], d);
                    ...
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(b) {
                            ...
                            case 0:
                                ...
                                d = a.getOperator(f.OperatorId.KeyboardWalk),
                                c = d.getWalkSpeed(),
                                0 !== c ? [3, 2] : [4, d.resetDefaultWalkSpeeds()];
                            case 1:
                                b.sent(),
                                b.label = 2;
                            case 2:
                ...
                a.prototype._applyDrawingSettings = function() {
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(b) {
                            switch (b.label) {
                            case 0:
                                return a = h.colorFromRgbString(h.getValueAsString("#settings-drawing-background")),
                                d = h.colorFromRgbString(h.getValueAsString("#settings-drawing-sheet")),
                                c = h.colorFromRgbString(h.getValueAsString("#settings-drawing-sheet-shadow")),
                                k = $("#settings-drawing-background-enabled").prop("checked"),
                                [4, this._viewer.sheetManager.setBackgroundSheetEnabled(k)];
                            case 1:
                                return b.sent(),
                                [4, this._viewer.sheetManager.setSheetColors(a, d, c)];
                            case 2:
                                return b.sent(),
                                [2]
                            }
                ...
                a.prototype._applyFloorplanSettings = function() {
                    return __awaiter(this, void 0, void 0, function() {
                        var a, d, c, k, l, e, m, q, p, n, r, v, w, t, x;
                        return __generator(this, function(b) {
                            switch (b.label) {
                            case 0:
    ...
    (function(h) {
        var m = function() {
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(u) {
                        ...
                        case 1:
                            ...
                            c.setViewpoint(e, h),
                            m = l + ".png",
                            [4, this._addSnapshot(c, m)];
                        case 2:
                            return u.sent(),
                            d.addViewpoint(l, e, m),
                            [2, d.addComment(g, k, a, l)]
                        }
                    })
                })
            };
            e.prototype._addSnapshot = function(c, a) {
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(d) {
                        ...
                        case 1:
                            return b = d.sent(),
                            c.addSnapshot(a, f.BCFSnapshot.snapshotDataFromImage(b)),
                            [2]
                        }
                    })
                })
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(e) {
                        ...
                        case 0:
                            ...
                            [4, f.BCFTopic.createTopic(this._viewer, c.getId(), c.getFilename(), a, b)];
                        case 1:
                            return d = e.sent(),
                            c.addTopic(d.getTopicId(), d),
                            g = this._buildTopic(c, d),
                            k = this._getBcfHtmlId(c.getId()),
                            null !== k && (l = document.getElementById(k),
                            null !== l && l.appendChild(g)),
                            [2, d]
                        }
                    })
                })
            ...
            e.prototype._initEvents = function() {
                ...
                if (null === a)
                    throw new f.CommunicatorError("container is null");
                this._events(a);
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(e) {
                        ...
                        case 1:
                            ...
                            k = this._topicCommentsGuidMap.get(c.getTopicId()),
                            void 0 !== k && (l = document.getElementById(k),
                            null !== l && l.appendChild(g)),
                            [2, d]
                        }
                    })
            ...
            e.prototype._buildTopic = function(c, a) {
                ...
                var k = a.getMarkup()
                  , l = k.getTopicTitle()
                  , e = this._getId();
                this._topicTitleGuidMap.set(g, e);
                d.appendChild(this._buildEditDiv(e, l, "Topic Title", function(d) {
                    b._setTopicTitle(a, d)
                }, "title"));
                l = a.getViewpoint("viewpoint.bcfv");
                null !== l && (e = this._getId(),
                this._viewpointIdMap.set(e, l),
                e = this._buildDiv(e, "", "viewpoint"),
                l = a.getSnapshot(l.getFilename()),
                null !== l && e.appendChild(this._buildImage(l.getUrl())),
                d.appendChild(e));
            ...
            e.prototype._buildSelectOption = function(c, a) {
            ...
            c.prototype._createCadViewNodes = function(a) {
                ...
                if (0 !== a.size) {
                    ...
                    a.forEach(function(a, g) {
                        b._cadViewIds.has(g) || !c && d.isWithinExternalModel(g) || d.isAnnotationView(g) || (b._cadViewIds.add(g),
                        b._tree.addChild(a, b._cadViewId(g), b._internalId, "view", !1, h.Desktop.Tree.CadView))
                    });
                    a.forEach(function(a, g) {
                    ...
                    a.forEach(function(a, g) {
                        ...
                        b._tree.addChild(a, b._cadViewId(g), b._internalId + b._annotationViewsString, "view", !1, h.Desktop.Tree.CadView))
                    })
                }
            };
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(d) {
                        ...
                        case 0:
                            ...
                            this._internalId !== b[0] ? [3, 3] : [4, this._viewer.operatorManager.getOperator(f.OperatorId.Handle).removeHandles()];
                        case 1:
                            return d.sent(),
        ...
        var m = function(e) {
            ...
            c.prototype._onNewModel = function() {
                ...
                this._layerNames.filter(function(d) {
                    var g = c._createId(c.layerPrefix);
                    c._layerIdMap.set(g, d);
                    c._idLayerMap.set(d, g);
                    var k = b.getLayerIdsFromName(d);
                    return null !== k && 0 < k.length ? (a._tree.appendTopLevelElement(d, g, "assembly", !0, !1),
                    !0) : !1
                });
            ...
            c.prototype._addLayerParts = function(a, b) {
                ...
                b.forEach(function(b) {
                    var e = g.getNodeType(b);
                    k || e !== f.NodeType.BodyInstance || (e = g.getNodeParent(b),
                    null !== e && (b = e));
                    e = g.getNodeName(b);
                    var l = c._createId(c.layerPartPrefix);
                    c._layerPartIdMap.set(l, b);
                    c._idLayerPartMap.set(b, l);
                    d._layerParts.has(b) || (d._layerParts.add(b),
                    d._tree.addChild(e, l, a, "assembly", !1, h.Desktop.Tree.Layers))
                })
            };
            c.prototype._addLayerPartContainers = function(a, b) {
                for (var d = Math.ceil(b.length / this._maxNodeChildrenSize), g = 0; g < d; ++g) {
                    var k = g * this._maxNodeChildrenSize
                      , e = Math.min(k + this._maxNodeChildrenSize, b.length)
                      , f = "Child Nodes " + k + " - " + e
                      , m = c._createId(c.layerPartContainerPrefix);
                    this._tree.addChild(f, m, a, "container", !0, h.Desktop.Tree.Layers);
                    this._addLayerParts(m, b.slice(k, e))
                }
            };
            c._createId = function(a) {
                return "" + a + c.separator + ++this._idCount
            };
    ...
    (function(h) {
        var m = function(e) {
            ...
            c.prototype._initEvents = function() {
                ...
                this._viewer.setCallbacks({
                    ...
                    sheetActivated: function(d) {
                        d !== a._currentSheetId && (a._currentSheetId = d,
            ...
            c.prototype._createContainerNodes = function(a, b) {
                for (var d = 1, c = this._maxNodeChildrenSize, k = 0; !(this._tree.addChild("Child Nodes " + d + " - " + Math.min(c, b.length), this._containerId(a, k), this._partId(a), "container", !0, h.Desktop.Tree.Model),
            ...
            c.prototype._processNodeChildren = function(a, b) {
                for (var d = this, c = this._viewer.model, k = null, e = 0; e < a.length; e++) {
                    var m = a[e]
                      ...
                      , p = "assembly"
                      , n = !1;
                    switch (c.getNodeType(m)) {
                    case f.NodeType.Body:
                    case f.NodeType.BodyInstance:
                        p = "body";
                        break;
                    case f.NodeType.Pmi:
                        null === k && (k = this._tree.addChild("PMI", this._pmiPartId(m), b, "modelroot", !0, h.Desktop.Tree.Model));
                        null !== k && (q = k.id,
                        p = "assembly");
                        break;
                    ...
                    n || this._tree.addChild(B, this._partId(m), q, p, 0 < c.getNodeChildren(m).length, h.Desktop.Tree.Model)
                }
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(g) {
                        ...
                        case 0:
                            ...
                            return [3, 5];
                        case 1:
                            return this._viewer.selectPart(parseInt(k[1], 10), b),
                            [3, 5];
                        case 2:
                        ...
                        case 3:
                            ...
                            [3, 5];
                        case 4:
                            return this._onContainerClick(k[1]),
                            [3, 5];
                        case 5:
                            return [2]
                        }
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(c) {
                        ...
                        case 1:
                            ...
                            return [4, this._viewer.setViewOrientation(f.ViewOrientation.Front, 0)];
                        case 2:
                            c.sent(),
                            c.label = 3;
                        case 3:
        ...
        (function(m) {
                ...
                a.prototype.updateModelTreeVisibilityState = function() {
                    if (this._assemblyTreeReadyOccurred) {
                        ...
                        for (var a = this._viewer.model, b = [a.getAbsoluteRootNode()], c = 0; c < b.length; c++) {
                            ...
                            if (h === f.BranchVisibility.Hidden)
                                this._fullHiddenParentIds.push(e);
                            else if (h === f.BranchVisibility.Mixed)
                                for (this._partialHiddenParentIds.push(e),
                                h = 0,
                                e = a.getNodeChildren(e); h < e.length; h++)
                                    b.push(e[h])
                        }
                        this._applyStyles()
                    }
            ...
            var a = function() {
                ...
                a.prototype._getTaggedId = function(a, b, c) {
                    return null !== c && "Annotation Views" === c && b === h.Desktop.Tree.CadView ? new e("Annotation Views") : this._parseTaggedId(a)
                };
                a.prototype.addChild = function(a, b, c, e, f, m) {
                    var d = this._getTaggedId(b, m, a);
                    if (null === d)
                        return null;
                    if (m === h.Desktop.Tree.Model && "container" !== e && null !== d.nodeId) {
                        if (this._loadedNodes.has(d.nodeId))
                            return null;
                    ...
                    var g = c.children("ul")
                      , k = m = !1;
                    null !== d.nodeId && (m = this._futureHighlightIds.has(d.nodeId),
                    k = this._futureMixedIds.has(d.nodeId),
                    m && this._futureHighlightIds.delete(d.nodeId),
                    k && this._futureMixedIds.delete(d.nodeId));
                    a = this._buildNode(a, b, e, f, m, k);
                    0 === g.length ? (e = document.createElement("ul"),
                    e.classList.add("ui-modeltree-children"),
                    c.append(e),
                    e.appendChild(a)) : g.get(0).appendChild(a);
                    m && (b = this._getListItem(b),
                ...
                a.prototype._buildPartVisibilityNode = function(a, b) {
                    ...
                    if ("measurement" !== b) {
                        ...
                        if (a === f.NodeType.Pmi || a === f.NodeType.PmiBody)
                ...
                a.prototype.updateSelection = function(a) {
                    ...
                    a = a.map(function(a) {
                        return a instanceof f.Event.NodeSelectionEvent && (a = a.getSelection(),
                        !a.isNodeSelection()) ? (console.assert(!1),
                        f.InvalidNodeId) : a.getNodeId()
                    });
                ...
                a.prototype._buildNode = function(a, b, c, e, f, h) {
                    void 0 === f && (f = !1);
                    void 0 === h && (h = !1);
                    ...
                    c.classList.add("ui-modeltree-label");
                    c.innerHTML = a;
                    c.title = a;
                    b.appendChild(c);
                    a = document.createElement("div");
                ...
                a.prototype._doUnfreezeSelection = function(a) {
                    for (var d = 0; d < a.length; d++) {
                        ...
                        null === e || e.hasClass("selected") ? null === e && this._futureHighlightIds.add(b) : (e.addClass("selected"),
                        this._selectedPartItems.push(e));
                        null !== c && (e = h.LayersTree.getLayerPartId(c),
                        null !== e && (e = this._getListItem(e),
                        null === e || e.hasClass("selected") ? null === e && this._futureHighlightIds.add(c) : (e.addClass("selected"),
                        this._selectedPartItems.push(e))),
                        c = this._getListItem(h.TypesTree.getComponentPartId(c)),
                        ...
                        null === b || b.hasClass("selected") || (b.addClass("selected"),
                        this._selectedPartItems.push(b))
                    }
                };
                a.prototype._doSelection = function(a, b) {
                    ...
                    if (null !== a) {
                        ...
                        if (g || e || m) {
                            ...
                            if (0 === a.lastIndexOf("container", 0) || c[0] === h.LayersTree.layerPartContainerPrefix)
                                return;
                            this._updateNonSelectionHighlight(p)
                        }
                        b && (this._lastItemId = a,
                        n = n && 1 === this._selectedPartItems.length,
                        this._triggerCallback("selectItem", a, "undefined" !== typeof key && (key.ctrl || key.command) || n ? f.SelectionMode.Toggle : f.SelectionMode.Set));
                ...
                a.prototype._scrollToItem = function(d) {
                    ...
                    this._scrollTimer.set(a._ScrollToItemDelayMs, function() {
                        ...
                        void 0 !== a && void 0 !== c && (a = a.top,
                        6 > a || a > c) && (b._scrollTimer.clear(),
                        b._treeScroll && (b._treeScroll.refresh(),
                        b._treeScroll.scrollToElement(d.get(0), h.DefaultUiTransitionDuration, !0, !0)))
                    })
                };
                ...
                a.prototype._updateLayerTreeSelectionHighlight = function() {
                    for (var a = this, b = 0, c = this._selectedLayers; b < c.length; b++) {
                        var e = c[b];
                        $("#" + h.LayersTree.getLayerId(e)).removeClass("selected")
                    }
                    this._mixedItemsLayer.forEach(function(b) {
                        b = a._viewer.model.getLayerName(b);
                        null !== b && $("#" + h.LayersTree.getLayerId(b)).addClass("mixed")
                    });
                    this._selectedLayers = this._viewer.selectionManager.getSelectedLayers();
                    b = 0;
                    for (c = this._selectedLayers; b < c.length; b++)
                        e = c[b],
                        $("#" + h.LayersTree.getLayerId(e)).addClass("selected"),
                        $("#" + h.LayersTree.getLayerId(e)).removeClass("mixed")
                };
                a.prototype._addMixedTypeClass = function(a) {
                    a = this._viewer.model.getNodeGenericType(a);
                    return null === a || this._mixedTypes.has(a) ? !1 : ($("#" + h.TypesTree.getGenericTypeId(a)).addClass("mixed"),
                ...
                a.prototype._updateTypesTreeSelectionHighlight = function() {
                    ...
                    for (b = this._selectedTypes; a < b.length; a++)
                        c = b[a],
                        c = $("#" + h.TypesTree.getGenericTypeId(c)),
                        c.addClass("selected"),
                        c.removeClass("mixed")
                };
                a.prototype._updateTreeSelectionHighlight = function(a) {
                    ...
                    f.Util.filterInPlace(this._selectedPartItems, function(d) {
                        ...
                        if (void 0 !== d) {
                            ...
                            if (null === d)
                                return !1;
                            if (0 > a.indexOf(d))
                                return $("#part" + h.ViewTree.separator + d).removeClass("selected"),
                                $("#typespart" + h.ViewTree.separator + d).removeClass("selected"),
                                (d = h.LayersTree.getLayerPartId(d)) && $("#" + d).removeClass("selected"),
                                !1
                        }
                        return !0
                    });
                    for (d = 0; d < a.length; d++)
                        e = a[d],
                        this._updateParentIdList(e),
                        this._updateMixedLayers(e),
                        this._updateMixedTypes(e);
                    d = 0;
                ...
                a.prototype._insertNodeAfter = function(a, b, c, e, h) {
                    ...
                    if (null === e.parentNode)
                        throw new f.CommunicatorError("element.parentNode is null");
                    ...
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(e) {
                            ...
                            case 0:
                                ...
                                d = b.getNodeVisibility(a),
                                c = b.hasEffectiveGenericType(a, f.StaticGenericType.IfcSpace),
                                [4, b.setNodesVisibility([a], !d, c ? !1 : null)];
                            case 1:
                                return e.sent(),
                                [2]
                            }
                ...
                a.prototype.updateTypesVisibilityIcons = function() {
                    ...
                    a.getGenericTypeIdMap().forEach(function(b, d) {
                        var c = !1
                          , e = !1;
                        b.forEach(function(b) {
                            var d = $("#visibility" + h.ViewTree.separator + h.TypesTree.getComponentPartId(b));
                            d.removeClass("partHidden");
                            a.getNodeVisibility(b) ? e = !0 : (c = !0,
                            d.addClass("partHidden"))
                        });
                        b = $("#visibility" + h.ViewTree.separator + h.TypesTree.getGenericTypeId(d));
                        b.removeClass("partHidden");
                        b.removeClass("partialHidden");
                    ...
                    this._viewer.model.getUniqueLayerNames().forEach(function(b) {
                        ...
                        if (null !== d) {
                            for (var c = !1, e = !1, g = 0; g < d.length; ++g) {
                                var f = d[g];
                                a._viewer.model.isDrawing() || (f = a._viewer.model.getNodeParent(d[g]));
                                null !== f && (f = $("#visibility" + h.ViewTree.separator + h.LayersTree.getLayerPartId(f)),
                                f.removeClass("partHidden"),
                                a._viewer.model.getNodeVisibility(d[g]) ? e = !0 : (c = !0,
                                f.addClass("partHidden")))
                            }
                ...
                if (void 0 !== b) {
                    ...
                    if (void 0 !== b) {
                        var e = c * this._maxNodeChildrenSize
                          , h = b.size - e < this._maxNodeChildrenSize ? b.size : e + this._maxNodeChildrenSize;
                        c = 0;
                        for (b = f.Util.setToArray(b).slice(e, h); c < b.length; c++)
            ...
            a.prototype._createContainerNodes = function(b, c) {
                ...
                if (void 0 === d)
                    ...
                    for (var e = 0; e < d.size; e += this._maxNodeChildrenSize) {
                        var l = "Child nodes " + e + " - " + (e + this._maxNodeChildrenSize > d.size ? d.size - 1 : e + this._maxNodeChildrenSize - 1)
                          , u = e / this._maxNodeChildrenSize
                          , B = f.UUID.create();
                        this._tree.addChild(l, a.getContainerId(B), b, "container", !0, h.Desktop.Tree.Types);
                        l = new m(c,u);
                        this._containerMap.set(B, l)
                    }
            };
