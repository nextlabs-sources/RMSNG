...
package com.nextlabs.rms.destiny.services;
...
public class UnauthorizedCallerFault extends Exception {
    ...
    private com.nextlabs.rms.destiny.framework.types.UnauthorizedCallerFault unauthorizedCallerFault;
    ...
    public UnauthorizedCallerFault(String message,
        com.nextlabs.rms.destiny.framework.types.UnauthorizedCallerFault unauthorizedCallerFault) {
        super(message);
    ...
    public com.nextlabs.rms.destiny.framework.types.UnauthorizedCallerFault getFaultInfo() {
