mainApp.controller('watermarkController',[ '$scope', 'userPreferenceService', '$timeout',
    function($scope, userPreferenceService, $timeout){
        ...
        var updateTags = function (){
            ...
            var children =  $('#watermark-div')[0].childNodes;
        ...
        $scope.validateWatermarkStr = function(){
            var watermarkStr = $scope.addWatermarkStr();
            return watermarkStr.length > 0 && watermarkStr.length <= 50;
        }

        $scope.$watch(function () {
            if ($('#watermark-div')[0]) {
                return $('#watermark-div')[0].innerHTML;
            }
        }, function(val) {
