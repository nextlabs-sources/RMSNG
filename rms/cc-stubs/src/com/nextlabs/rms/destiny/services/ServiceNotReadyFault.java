...
public class ServiceNotReadyFault extends Exception {
    ...
    private com.nextlabs.rms.destiny.framework.types.ServiceNotReadyFault serviceNotReadyFault;
    ...
    public ServiceNotReadyFault(String message,
        com.nextlabs.rms.destiny.framework.types.ServiceNotReadyFault serviceNotReadyFault) {
        super(message);
    ...
    public com.nextlabs.rms.destiny.framework.types.ServiceNotReadyFault getFaultInfo() {
