        ...
        <script type="text/javascript">
            ...
            function ldapLogin(){
                ...
                $.post('${pageContext.request.contextPath}/IdpManager/LdapAuth/LdapAuthFinish',
                    ...
                    } else if(data.code && data.code == '403l') {
                        displayError("Cannot login as admin.");
            ...
            function googleLogin() {
                showLoading();
                var search = window.location.search + ( window.location.search.match( /[\?]/g ) ? '&' : '?' ) + "tenant="+decodeURIComponent("${resolvedTenant}")+"&loginApp=admin";
            ...
            function samlLogin(idpId) {
                showLoading();
                var search = window.location.search + ( window.location.search.match( /[\?]/g ) ? '&' : '?' ) + 'id=' + idpId + "&tenant="+decodeURIComponent("${resolvedTenant}")+"&loginApp=admin";
