...
public class GetWatermarkContentCommand extends AbstractCommand {
    ...
    public void doAction(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            LOGGER.debug("Getting watermark for document: {} with documentId: {}", cachedFile.getFileName(), documentId);

            response.setContentType("image/png");
            response.getOutputStream().write(cachedFile.getWatermarkPNG());
