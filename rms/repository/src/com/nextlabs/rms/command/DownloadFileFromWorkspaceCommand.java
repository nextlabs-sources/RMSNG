...
public class DownloadFileFromWorkspaceCommand extends AbstractCommand {
    ...
    public void doAction(HttpServletRequest request, HttpServletResponse response)
        ...
        String urlString = ("true".equals(decrypt)) ? HTTPUtil.getInternalURI(request) + "/rs/enterprisews/decrypt" : HTTPUtil.getInternalURI(request) + "/rs/enterprisews/v2/download";
            ...
            switch (statusCode) {
                case 200:
                    ...
                    if (is != null) {
                        ...
                        redirectToErrorPage(request, response, "err.workspace.file.download");
                    }
                    break;
                case 401:
                ...
                case 403:
                    ...
                    break;
                case 404:
                    redirectToErrorPage(request, response, "err.workspace.file.not.found");
                    break;
                default:
                    if ("true".equals(decrypt)) {
                        redirectToErrorPage(request, response, "err.workspace.file.extract");
                    } else {
                        redirectToErrorPage(request, response, "err.workspace.file.download");
                    }
                    break;
